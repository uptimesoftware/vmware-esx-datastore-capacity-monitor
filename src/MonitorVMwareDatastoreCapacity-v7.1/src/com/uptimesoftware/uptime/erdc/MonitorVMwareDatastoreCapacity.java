 ...
 *
 * The purpose of this extension is to retrieve metrics from a Netapp device via SNMP.
 * 
 */
    ...
    */
    ...
    protected void monitor(){
        try {
            ...
            UptimeHostByNameLoader idLoader = new UptimeHostByNameLoader();
            MonitorPerformanceCheckDataRetriever retriever = new MonitorPerformanceCheckDataRetriever();
            
            idLoader.setName(getHostname());
            UptimeHost hostId = idLoader.load();
            memoryLoader.setEntityId(hostId.getEntityId());
            // Author: Joel Pereira
            // May 1, 2012
            ...
            // v7.1
            retriever.setEntityId(hostId.getEntityId());
            // get all the values
